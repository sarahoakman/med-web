==========================================================
 TeeChart for PHP version 2018 Free
...
Thank you for download the TeeChart for PHP Version 2018 Open Source Free.
...
Please check the License document included into the zip file.

Please read Install.txt file which includes all the instructions to be able to use the TeeChart for PHP components under PHP directly 
or throught several PHP IDEs.
