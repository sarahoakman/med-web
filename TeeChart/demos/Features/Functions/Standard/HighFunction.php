<?php
        ...
        $chart1->getChart()->getHeader()->setText("High Function");
        ...
        $high = new High();
        $high->setChart($chart1->getChart());
        $high->setPeriod(0); // all points
        $line->setDataSource($bar);
        $line->setColor(new Color(237,28,36));
        $line->setFunction($high);

//  TODO       if ($this->cbPeriod->Checked) {
...
//        }
        ...
        $rand=rand();
        print '<font face="Verdana" size="2">High Function Chart<p>';
...
<head>
  <title>High Function Charts</title>
