<?php
        ...
        $chart1->getChart()->getHeader()->setText("Count Function");
        ...
        $count = new Count();
        $count->setChart($chart1->getChart());
        $line->setDataSource($bar);
        $line->setColor(new Color(237,28,36));
        $line->setFunction($count);

        $chart1->render("chart1.png");
        $rand=rand();
        print '<font face="Verdana" size="2">Count Function Chart<p>';
...
<head>
  <title>Count Function Charts</title>
