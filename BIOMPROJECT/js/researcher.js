// Checks if given inputs satisfy making a new subject
...
function verify() {
    ...
    if (firstname == "block" || lastname == "block" || dob == "block" || gender == "block" || contact == "block") {
        alert("Invalid form, subject not added");
        return false;
    }
